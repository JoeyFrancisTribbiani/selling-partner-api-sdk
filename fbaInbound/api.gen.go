...
func NewGetInboundGuidanceRequest(endpoint string, params *GetInboundGuidanceParams) (*http.Request, error) {
	...
	if params.SellerSKUList != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "SellerSKUList", *params.SellerSKUList); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.ASINList != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "ASINList", *params.ASINList); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
func NewGetShipmentsRequest(endpoint string, params *GetShipmentsParams) (*http.Request, error) {
	...
	if params.ShipmentStatusList != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "ShipmentStatusList", *params.ShipmentStatusList); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.ShipmentIdList != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "ShipmentIdList", *params.ShipmentIdList); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
func NewGetLabelsRequest(endpoint string, shipmentId string, params *GetLabelsParams) (*http.Request, error) {
	...
	if params.PackageLabelsToPrint != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "PackageLabelsToPrint", *params.PackageLabelsToPrint); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
