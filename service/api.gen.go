...
func NewGetServiceJobsRequest(endpoint string, params *GetServiceJobsParams) (*http.Request, error) {
	...
	if params.ServiceOrderIds != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "serviceOrderIds", *params.ServiceOrderIds); err != nil {
			return nil, err
	...
	if params.ServiceJobStatus != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "serviceJobStatus", *params.ServiceJobStatus); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
