...
func NewGetReportsRequest(endpoint string, params *GetReportsParams) (*http.Request, error) {
	...
	if params.ReportTypes != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "reportTypes", *params.ReportTypes); err != nil {
			return nil, err
	...
	if params.ProcessingStatuses != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", false, "processingStatuses", *params.ProcessingStatuses); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
